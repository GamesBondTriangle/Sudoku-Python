...
class getBoard:
    ...
    # Import board from Sudoku API
        ...
        response_API = requests.get('https://sudoku-api.vercel.app/api/dosuku')
        ...
        if response_API.status_code == 200:
            ...
            try:
                ...
                board = parse_json['newboard']['grids'][0]['value']
...
class Grid:
    board = getBoard.fetch_board

    def __init__(self, rows, cols, width, height, win):
        self.rows = rows
        self.cols = cols
        self.board_instance = getBoard()
    ...
    # Updates the current model, when the number is input it update it
